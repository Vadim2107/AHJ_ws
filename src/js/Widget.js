export default class Widget {
  ...
  createForm() {
    ...
    form.innerHTML = ` <h2>Выберите псевдоним</h2>
        <input class="input widget-input" type="text" name="nick" placeholder="Например, Vadim" required>
  ...
  // показываем сообщение об ошибке когда выбран уже существующий ник
  ...
  // удаляем регистрационную форму
  deleteForm() {
    this.container.removeChild(this.container.firstChild);
  }

  // создаем окно чата, если его еще не было на странице
  showChat() {
  ...
  // создаем список всех пользователей онлайн
  showUsers() {
